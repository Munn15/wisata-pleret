...
<section class="hero-wrap hero-wrap-2 js-fullheight" style="background-image: url('/Assets/User/images/sasur2.jpg');" data-stellar-background-ratio="0.5">
	<div class="overlay"></div>
	<div class="container">
		<div class="row no-gutters slider-text js-fullheight align-items-end justify-content-center">
			<div class="col-md-9 ftco-animate pb-5 text-center">
				<h1 class="mb-3 bread">SAWAH SURJAN</h1>
				<p class="breadcrumbs"><span class="mr-2"><a href="/">Beranda <i class="ion-ios-arrow-forward"></i></a></span><span class="mr-2">Destinasi <i class="ion-ios-arrow-forward"></i></span><span>Sawah Surjan </span></p>
			</div>
		</div>
	</div>
</section>
...
<section class="ftco-section" style="padding-top: 5em;">
	...
	<div class="row justify-content-center">
		<div class="col-md-8">
			...
			<div class="container">
				<form action="<?= base_url('sawah/sendMessage') ?>" method="post">
					<div class="form-row">
